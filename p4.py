    ...
    for lesson_content in content['content']:
        ...
        for subcategory in lesson_content['subcategories']:
            ...
            for sentence in subcategory['sentences']:
                ...
                # Send entire array to Claude
                question = f"Convert this Chinese word array to korean array (with tone marks): {words_list}. Return ONLY the korean array in the exact same format, like ['korean1', 'korean2', 'korean3']. No other text."
                    ...
                    if result.stdout:
                        ...
                        if match:
                            try:
                                ...
                                pinyin_list = eval(match.group())
                                print(f"Extracted pinyin list: {pinyin_list}")
                            except:
                                print("Failed to parse pinyin list")
                                pinyin_list = []
                        else:
                ...
                sentence['words']['pinyin'] = pinyin_list
                print(f"Updated pinyin: {pinyin_list}")
                print("---")
